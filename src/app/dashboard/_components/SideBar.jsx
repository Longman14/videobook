  ...
  return (
    <div className='fixed h-full md:w-64 p-5 shadow-md'>
        ...
        <ul>
            {Menu.map((item, index)=>(
                <Link href={item.path}>
                <div className={`flex items-center gap-2 text-gray-600 p-3 cursor-pointer hover:text-black hover:bg-gray-100 rounded-lg mb-3 ${item.path==path&&'bg-gray-100 text-black'}`}>
